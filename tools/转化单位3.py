...
while True:
    ...
    with open('D:/company/py/yolo/calibration_file/source/poses{}{}.txt'.format(shiwei, count), 'r') as f:
        ...
        with open('D:/company/py/yolo/calibration_file/trans/poses.txt', 'a') as F:
             ...
             #    if i==5:
             #        F.write('\n')
        with open('D:/company/py/yolo/calibration_file/trans/vector.txt', 'a') as K:
             K.write('Tmarker2world(:,{}) = '.format(10*shiwei+(count+1)))
             K.write('['+str(cur_pose[0])+' '+str(cur_pose[1])+' '+str(cur_pose[2])+']\';')
             K.write('\n')
             #    if i!=5:
             #        F.write(',')
             #    if i==5:
